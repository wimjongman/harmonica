 ...
 * <ul>
 *   <li>{@link com.weltevree.harmonica.model.impl.GroupImpl#getName <em>Name</em>}</li>
 *   <li>{@link com.weltevree.harmonica.model.impl.GroupImpl#getPerson <em>Person</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class GroupImpl extends EObjectImpl implements Group {
	...
	public EList<Person> getPerson() {
		if (person == null) {
			person = new EObjectContainmentEList<Person>(Person.class, this, ModelPackage.GROUP__PERSON);
		}
		return person;
	}
