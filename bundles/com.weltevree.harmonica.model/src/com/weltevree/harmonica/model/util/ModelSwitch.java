...
public class ModelSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ModelPackage.HARMONICA: {
				Harmonica harmonica = (Harmonica)theEObject;
				T result = caseHarmonica(harmonica);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ModelPackage.TAB: {
			...
			case ModelPackage.MANUFACTURER: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Harmonica</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Harmonica</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseHarmonica(Harmonica object) {
		return null;
	}
