...
/**
 * This is the item provider adapter for a {@link com.weltevree.harmonica.model.Key} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Key_pitch_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Key_pitch_feature", "_UI_Key_type"),
				 ModelPackage.Literals.KEY__PITCH,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ModelPackage.Literals.KEY__NAME,
				 true,
				 false,
				 false,
