...
/**
 * This is the item provider adapter for a {@link com.weltevree.harmonica.model.Group} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GroupItemProvider
	...
	protected void addPersonPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Group_person_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Group_person_feature", "_UI_Group_type"),
				 ModelPackage.Literals.GROUP__PERSON,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ModelPackage.Literals.GROUP__PERSON);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Group.class)) {
			case ModelPackage.GROUP__NAME:
				...
				return;
			case ModelPackage.GROUP__PERSON:
