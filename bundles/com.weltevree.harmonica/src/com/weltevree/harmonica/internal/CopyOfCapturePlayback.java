 ...
 */
public class CopyOfCapturePlayback extends JPanel implements ActionListener, ControlContext {
    ...
    public static void main(String s[]) {
        CopyOfCapturePlayback capturePlayback = new CopyOfCapturePlayback();
